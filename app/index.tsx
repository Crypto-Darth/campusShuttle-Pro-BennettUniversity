...
import { Text, View, TouchableOpacity, StyleSheet, ScrollView, Image, Dimensions, Platform, Switch, Modal, TextInput, FlatList } from 'react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>CampusShuttle Pro</Text>
      </View>
